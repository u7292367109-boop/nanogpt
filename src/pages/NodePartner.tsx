      ...
      <div className="px-4 py-6 space-y-6 pb-10">
        ...
        <div className="card">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            The AI age is reshaping our view of software and services. Compute resources and data training are emerging as core enablers of the AI sector. UltraGPT empowers people to engage with AI at scale and earn ongoing financial rewards from their participation.
          </p>
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {[
              'Aligned with UltraGPT\'s platform vision and values',
              ...
              'Ready to meet UltraGPT node partner goals',
            ].map((req) => (
