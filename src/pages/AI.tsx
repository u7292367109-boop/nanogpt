...
const EXAMPLE_QUESTIONS = [
  ...
  'How can I maximize earnings on UltraGPT?',
  'How does the referral system work?',
]

const AI_RESPONSES: Record<string, string> = {
  default: "UltraGPT harnesses idle computing power from devices worldwide to train AI models. By participating, you contribute to the AI training ecosystem and earn USDT rewards in return. The more tasks you complete and the higher your level, the greater your earnings potential.",
  earning: "You can earn on UltraGPT by: 1) Running training tasks on your device, 2) Inviting friends to join and earning team rewards (up to 10%), 3) Upgrading your level to access higher-return task types like Picture and Video tasks.",
  ...
  ai: "Artificial intelligence is creating massive demand for computing power. Traditional centralized data centers can't scale fast enough. UltraGPT bridges this gap by aggregating idle compute from millions of devices, enabling anyone to participate in and profit from the AI revolution.",
}
    ...
    <div className="page-container">
      ...
      <header className="flex items-center gap-3 px-4 py-3 bg-surface-card border-b border-surface-border sticky top-0 z-40">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-none">UltraGPT AI</p>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {messages.length === 0 && (
          <div className="text-center py-6">
            ...
            <h2 className="text-white font-bold text-xl mb-1">Welcome to UltraGPT AI</h2>
